...
from src.models.nam.trainer.metrics import *
from src.models.nam.utils.loggers import TensorBoardLogger
...
class Trainer:
    ...
    def __init__(self, 
        ...
        self.disable_tqdm = True # Note: done to prevent cluttering the output... remove this line to see progress bars
